 ...
 */
package me.ccbluex.liquidbounce.event
 ...
 */
class ClickBlockEvent(val clickedBlock: WBlockPos?, val WEnumFacing: IEnumFacing?,val clickedBlock2: BlockPos?) : Event()

/**
 * Called when player clicks a block
 */
class ClickBlockEvent2(val clickedBlock2: BlockPos) : Event()
