 ...
 */
package me.ccbluex.liquidbounce.ui.client.clickgui.style.styles;
...
import me.ccbluex.liquidbounce.features.module.modules.render.ClickGUI;
...
import me.ccbluex.liquidbounce.ui.client.clickgui.style.Style;
...
import me.ccbluex.liquidbounce.ui.font.GameFontRenderer;
...
public class CNStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        float textWidth = FontLoaders.C15.getStringWidth("§f" + StringUtils.stripControlCodes(panel.getName()));
        FontLoaders.C15.drawString("§f" + panel.getName(), (int) (panel.getX() - (textWidth - 100.0F) / 2F), panel.getY() + 7, -16777216);
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        int textWidth = FontLoaders.C15.getStringWidth(text);

        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + FontLoaders.C15.getHeight() + 3, 1, new Color(255, 255, 255, 90).getRGB(), Integer.MIN_VALUE);
        GlStateManager.resetColor();
        FontLoaders.C15.drawString(text, mouseX + 12, mouseY + (FontLoaders.C15.getHeight()) / 2, Integer.MAX_VALUE);
    }

    @Override
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        GlStateManager.resetColor();
        FontLoaders.C15.drawString(buttonElement.getDisplayName(), (int) (buttonElement.getX() - (FontLoaders.C15.getStringWidth(buttonElement.getDisplayName()) - 100.0f) / 2.0f), buttonElement.getY() + 6, buttonElement.getColor());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        GlStateManager.resetColor();
        FontLoaders.C15.drawString(moduleElement.getDisplayName(), (int) (moduleElement.getX() - (FontLoaders.C15.getStringWidth(moduleElement.getDisplayName()) - 100.0f) / 2.0f), moduleElement.getY() + 6, moduleElement.getModule().getState() ? guiColor : Integer.MAX_VALUE);

        final List<Value<?>> moduleValues = moduleElement.getModule().getValues();

        if(!moduleValues.isEmpty()) {
            FontLoaders.C15.drawString("+", moduleElement.getX() + moduleElement.getWidth() - 8, moduleElement.getY() + (moduleElement.getHeight() / 2), Color.WHITE.getRGB());
            ...
            if(moduleElement.isShowSettings()) {
                ...
                for(final Value value : moduleValues) {
                    ...
                    if (value instanceof BoolValue) {
                        ...
                        final float textWidth = FontLoaders.C15.getStringWidth(text);
                        ...
                        GlStateManager.resetColor();
                        FontLoaders.C15.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, ((BoolValue) value).get() ? guiColor : Integer.MAX_VALUE);
                        yPos += 12;
                        ...
                        RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 4, yPos + 2, moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth(), yPos + 14, Integer.MIN_VALUE);
                        GlStateManager.resetColor();
                        FontLoaders.C15.drawString("§c" + text, moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 0xffffff);
                        FontLoaders.C15.drawString(listValue.openList ? "-" : "+", (int) (moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() - (listValue.openList ? 5 : 6)), yPos + 4, 0xffffff);
                        ...
                        for(final String valueOfList : listValue.getValues()) {
                            final float textWidth2 = FontLoaders.C15.getStringWidth(">" + valueOfList);
                            ...
                            if (listValue.openList) {
                                ...
                                GlStateManager.resetColor();
                                FontLoaders.C15.drawString(">", moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, Integer.MAX_VALUE);
                                FontLoaders.C15.drawString(valueOfList, moduleElement.getX() + moduleElement.getWidth() + 14, yPos + 4, listValue.get() != null && listValue.get().equalsIgnoreCase(valueOfList) ? guiColor : Integer.MAX_VALUE);
                                yPos += 12;
                            }
                        }
                        ...
                        GlStateManager.resetColor();
                        FontLoaders.C15.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 0xffffff);
                        yPos += 22;
                        ...
                        FontLoaders.C15.drawString(displayString, moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, Color.WHITE.getRGB());
                        int stringWidth = FontLoaders.C15.getStringWidth(displayString);
                        ...
                        float textWidth = FontLoaders.C15.getStringWidth(text);
