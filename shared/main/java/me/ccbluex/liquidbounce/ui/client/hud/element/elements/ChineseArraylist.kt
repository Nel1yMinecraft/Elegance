...
import me.ccbluex.liquidbounce.ui.client.hud.element.Side.Horizontal
import me.ccbluex.liquidbounce.ui.client.hud.element.Side.Vertical
...
import me.ccbluex.liquidbounce.utils.blur.BlurUtils
import me.ccbluex.liquidbounce.utils.render.*
...
/**
 * CustomHUD Chinese Arraylist element
 *
 * Shows a list of enabled modules
 */
@ElementInfo(name = "ChineseArraylist", single = true)
class ChineseArraylist(
    ...
    private val fontValue = CNFontValue("Font", FontLoaders.C15)
    ...
    private fun getModName(mod: Module): String {
        var displayName: String = getmodname2(mod) + getModTag(mod)
    ...
    private fun getmodname2(mod: Module): String {
        return if(mod.chinesename != "") {
            mod.chinesename
        } else {
            mod.name
        }
