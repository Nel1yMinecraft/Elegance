...
import me.ccbluex.liquidbounce.features.special.AutoReconnect.delay
import me.ccbluex.liquidbounce.features.special.BungeeCordSpoof
import me.ccbluex.liquidbounce.file.FileManager
import me.ccbluex.liquidbounce.ui.client.GuiBackground.Companion.enabled
import me.ccbluex.liquidbounce.ui.client.GuiBackground.Companion.particles
import me.ccbluex.liquidbounce.ui.client.altmanager.sub.GuiDonatorCape.Companion.capeEnabled
import me.ccbluex.liquidbounce.ui.client.altmanager.sub.GuiDonatorCape.Companion.transferCode
import me.ccbluex.liquidbounce.ui.client.altmanager.sub.altgenerator.GuiTheAltening.Companion.apiKey
                    ...
                    if (args.size > 2) {
                        ...
                        if (file.exists()) {
                            ...
                            try {
                                ...
                                LiquidBounce.hud.addNotification(Notification("Notifications", "Loaded config ${args[2]}.json.", NotifyType.INFO))
                                playEdit()
                                return
                            } catch (e: Throwable) {
