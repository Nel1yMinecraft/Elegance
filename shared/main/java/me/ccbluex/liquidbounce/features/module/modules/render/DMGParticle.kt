...
import me.ccbluex.liquidbounce.features.module.modules.render.DMGPUtil.Location
import me.ccbluex.liquidbounce.features.module.modules.render.DMGPUtil.Particles
...
class DMGParticle : Module() {
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        val entity = if (ka.target == null) null else ka.target!!.unwrap()
