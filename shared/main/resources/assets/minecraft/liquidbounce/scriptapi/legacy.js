...
var _AdaptedModule = function (module) {
    ...
    this.moduleManager = Java.type("me.ccbluex.liquidbounce.LiquidBounce").moduleManager;
...
var _ModuleManager = function () {
    ...
    this.moduleManager = Java.type("me.ccbluex.liquidbounce.LiquidBounce").moduleManager;
    this.Module = Java.type("me.ccbluex.liquidbounce.features.module.Module");
...
var _CommandManager = function () {
    ...
    this.Command = Java.type("me.ccbluex.liquidbounce.features.command.Command");
    this.commandManager = Java.type("me.ccbluex.liquidbounce.LiquidBounce").commandManager;
